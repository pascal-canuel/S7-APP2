...
class SegmentationNetwork(nn.Module):
    def __init__(self):
        ...
        # Up 4
        self.upsample_4 = nn.ConvTranspose2d(in_channels=64, out_channels=64, kernel_size=2, padding=0, stride=2)  # 64x26x26
        ...
        # Up 5
        self.upsample_5 = nn.ConvTranspose2d(in_channels=32, out_channels=32, kernel_size=2, padding=0, stride=2)  # 32x52x52
        ...
        self.conv_5_3 = nn.Conv2d(in_channels=16, out_channels=4, kernel_size=2, padding=1, stride=1)  # 4x53x53
